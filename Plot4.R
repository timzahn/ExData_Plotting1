...
#Create first figure
plot(dataset$dateTime, type="l" ,dataset$Global_active_power, xlab="", ylab="Global Active Power")
...
legend("topright", legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), lty = 1, col=c("black","red","blue"),cex=0.3)
